...
export async function POST(request: NextRequest) {
  ...
  console.log('[AUTHZ/token] User from requireAuth:', JSON.stringify({
    id: user.id,
    email: user.email,
  ...
  console.log('[AUTHZ/token] Request:', { audience, scopes, purpose, userId: user.id });
  ...
  try {
    ...
    console.error('[AUTHZ] Token exchange failed:', err);
