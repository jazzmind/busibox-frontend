...
export function CitationPreview({ open, data, align = 'left' }: CitationPreviewProps) {
  return (
    <div
      className="pointer-events-none absolute z-50 rounded-lg border bg-[var(--marine-surface)] shadow-lg"
      style={{
    ...
    >
      <div className="flex items-center justify-between gap-2 px-4 pb-2 pt-3">
        <div className="flex min-w-0 items-center gap-2">
          <FileText className="h-4 w-4 flex-shrink-0" style={{ color: 'var(--marine-teal)' }} />
          <span
      ...
      <div className="border-t px-4 py-3" style={{ borderColor: 'var(--marine-border)' }}>
        <p
          className="text-sm leading-[22px]"
          style={{ color: 'var(--marine-text-body)' }}
        >
      ...
      <span
        aria-hidden
        className="absolute h-2 w-2 rotate-45 border-b border-r bg-[var(--marine-surface)]"
        style={{
          bottom: -5,
