...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      >
        <FetchWrapper skipAuthUrls={['/api/auth/refresh', '/api/auth/session', '/api/session', '/api/logout', '/api/sso', '/portal/api/sso/refresh', '/api/auth/exchange']} />
        <ThemeProvider>
          <SessionProvider>
