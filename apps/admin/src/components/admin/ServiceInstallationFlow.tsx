...
const SERVICE_GROUPS: ServiceGroup[] = [
  ...
  },
  {
    ...
    description: 'Web applications built and deployed inside the core-apps container',
    services: [
      {
      ...
      },
      {
        ...
        features: [],
        dockerService: 'busibox-chat',
        healthEndpoint: '/chat/api/health',
        status: 'pending',
        logs: [],
      },
      {
        id: 'busibox-documents-app',
        name: 'Documents',
        description: 'Document management and knowledge base',
        features: [],
        dockerService: 'busibox-documents',
        healthEndpoint: '/documents/api/health',
        status: 'pending',
        logs: [],
      },
      {
        id: 'busibox-media-app',
        name: 'Media',
        description: 'AI media generation and management',
        features: [],
        dockerService: 'busibox-media',
        healthEndpoint: '/media/api/health',
        status: 'pending',
        logs: [],
      },
      {
