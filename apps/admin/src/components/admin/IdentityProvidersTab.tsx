/**
 * Identity Providers tab content.
 *
...
import { Save, Eye, EyeOff, RefreshCw, CheckCircle, AlertCircle, Shield } from 'lucide-react';
...
export function IdentityProvidersTab() {
  const [, setConfigs] = useState<IdpConfig[]>([]);
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Identity Providers</h2>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Microsoft Entra ID</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400">Azure Active Directory single sign-on</p>
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 pr-10"
              />
              <button
                type="button"
              ...
              <ol className="text-sm text-blue-800 space-y-1 list-decimal list-inside">
                ...
                <li>
                  ...
                  <code className="bg-blue-100 px-1 rounded text-xs">
                    https://ai.jaycashman.com/portal/api/auth/callback/microsoft
                  </code>
                </li>
                <li>
                  Under API permissions, add:{' '}
                  <code className="bg-blue-100 px-1 rounded text-xs">openid</code>,{' '}
                  <code className="bg-blue-100 px-1 rounded text-xs">profile</code>,{' '}
                  <code className="bg-blue-100 px-1 rounded text-xs">email</code>,{' '}
                  <code className="bg-blue-100 px-1 rounded text-xs">User.Read</code>
                </li>
