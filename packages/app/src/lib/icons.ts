...
export interface Icon {
  name: IconName;
  label: string;
  category: 'general' | 'media' | 'productivity' | 'tech' | 'business';
  svg: string;
}
 ...
 * Get icon by name
 */
export function getIcon(name: IconName): Icon | undefined {
 ...
 */
export function getIconsByCategory(category: Icon['category']): Icon[] {
 ...
 */
export function getCategories(): Icon['category'][] {
