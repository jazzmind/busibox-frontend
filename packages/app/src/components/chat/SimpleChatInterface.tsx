...
import type { ChatMessageRequest, Message, Attachment } from '../../types/chat';
...
interface DisplayMessage {
  ...
  createdAt?: Date;
  agentName?: string;
  thoughts?: ExecutionEvent[];  // Stored thoughts for this message
}
  ...
  return (
    <div className={`flex flex-col h-full min-h-0 bg-white dark:bg-gray-900 ${className}`}>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto p-4 space-y-4 bg-white dark:bg-gray-900">
        ...
        {/* Agentic streaming content with ThinkingToggle component */}
        {useAgenticStreaming && (isLoading || streamingContent) && (
          <div className="flex gap-4 justify-start">
            ...
            <div className="max-w-3xl flex-1">
              <div className="rounded-lg px-4 py-3 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100">
                {/* ThinkingToggle component - consistent with MessageList */}
                {thoughts.length > 0 && (
